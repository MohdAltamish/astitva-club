    ...
    <div className="min-h-screen bg-black-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-black-900 border border-gold-deep/30 rounded-3xl p-8 md:p-10 relative z-10 shadow-[0_0_50px_rgba(212,175,55,0.08)]">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-kicker text-gold-mid uppercase tracking-widest mb-1.5">
              Admin Email
            </label>
            <input
              type="email"
              ...
              className="w-full bg-black-950 border border-gold-deep/30 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-gold-mid transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-2 py-3.5 px-4 rounded-xl font-display font-semibold text-sm tracking-wide bg-gradient-to-r from-gold-light via-gold-mid to-gold-deep text-black-950 hover:brightness-110 shadow-[0_0_20px_rgba(212,175,55,0.3)] transition-all cursor-pointer disabled:opacity-50"
          >
        ...
        <div className="relative my-6 text-center">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gold-deep/20" />
          </div>
          <span className="relative bg-black-900 px-3 text-[10px] font-mono text-gray-500 uppercase tracking-widest">
            OR
          </span>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 rounded-xl border border-gold-deep/30 bg-black-950 text-white hover:border-gold-mid hover:bg-black-800 transition-all flex items-center justify-center gap-3 text-xs font-medium cursor-pointer disabled:opacity-50"
        >
        ...
        <div className="mt-8 text-center">
          <Link
            href="/"
            className="text-xs text-gray-500 hover:text-gold-mid transition-colors tracking-wide"
          >
